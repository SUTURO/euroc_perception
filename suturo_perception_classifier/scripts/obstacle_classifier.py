...
from suturo_perception_classifier.obstacle_classifier import ObstacleClassifier as CF
import argparse
def dump():
    pass
...
def main(task, logging):
    ...
    rospy.Service("/suturo/ObstacleClassifier", Classifier, c.classify_object)
    # spin the wheel
